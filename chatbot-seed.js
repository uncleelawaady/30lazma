// ===== NewlyNow — chatbot default knowledge base (shared: widget + dashboard) =====
window.CHATBOT_SEED = {
    botName: 'مساعد Elawaady XDigital',
    welcome: 'أهلًا! 👋 أنا مساعد Elawaady XDigital (EXD). أقدر أجاوبك عن خدماتنا، الطلبات، الدفع، الوساطة وقوانينها، والمزيد.\nاختر فئة من الأزرار تحت أو اكتب سؤالك مباشرة:',
    faqs: [
      { q: 'مين إنتوا؟ / من نحن؟', cat: 'عام', kw: 'من نحن,مين انتو,من انتم,العوضي,elawaady,exd,تعريف,المتجر,المنصة',
        a: 'إحنا Elawaady XDigital (EXD) — منصة ومتجر متخصص في الخدمات الرقمية، السوشيال ميديا، بيع وشراء ونقل ملكية الحسابات والقنوات والصفحات، التوثيق، الإعلانات، الاشتراكات، الذكاء الاصطناعي والأتمتة، والوساطة الآمنة. هدفنا تنظيم السوق الرقمي وحفظ حقوق كل الأطراف.' },
      { q: 'إيه الخدمات المتاحة؟', cat: 'الخدمات', kw: 'خدمات,الخدمات المتاحة,بتقدموا ايه,services,عندكم ايه',
        a: 'خدماتنا تشمل:\n• خدمات السوشيال ميديا\n• بيع وشراء الحسابات والصفحات والقنوات\n• اشتراكات وأدوات AI\n• الذكاء الاصطناعي والأتمتة\n• المواقع والأنظمة والبوتات\n• تحقيق شروط الربح\n• توثيق الحسابات\n• إدارة الحملات الإعلانية\n• الوساطة الرقمية الآمنة\n• الدومينات الاستثمارية\n\n[تصفّح كل الأقسام](index.html#categories)' },
