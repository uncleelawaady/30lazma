...
window.CHATBOT_SEED = {
    botName: 'مساعد NewlyNow',
    welcome: 'أهلًا! 👋 أنا مساعد NewlyNow. أقدر أجاوبك عن خدماتنا، الطلبات، الدفع، الوساطة وقوانينها، والمزيد.\nاختر فئة من الأزرار تحت أو اكتب سؤالك مباشرة:',
    faqs: [
      { q: 'مين إنتوا؟ / من نحن؟', cat: 'عام', kw: 'من نحن,مين انتو,من انتم,العوضي,elawaady,exd,تعريف,المتجر,المنصة',
        a: 'إحنا NewlyNow — منصة ومتجر متخصص في الخدمات الرقمية، السوشيال ميديا، بيع وشراء ونقل ملكية الحسابات والقنوات والصفحات، التوثيق، الإعلانات، الاشتراكات، الذكاء الاصطناعي والأتمتة، والوساطة الآمنة. هدفنا تنظيم السوق الرقمي وحفظ حقوق كل الأطراف.' },
