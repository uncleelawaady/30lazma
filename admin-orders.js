  ...
  function card(o) {
    ...
    return `<div class="nn-order-card" data-id="${esc(o._id)}">
      ...
      <div class="nn-order-controls">
        ...
        <div><button class="btn btn-sm nn-order-save" type="button"><i class="fas fa-floppy-disk"></i> حفظ الحالة</button></div>
      </div>
      <p class="hint" style="margin-top:8px">حالة الدفع لا تتغير من هنا؛ تُدار من تبويب المدفوعات أو Webhook الموثق. السجل لا يُحذف؛ استخدم «ملغي» عند الإلغاء.</p>
    </div>`;
  }
